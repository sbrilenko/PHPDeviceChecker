...
class PHPDeviceChecker
{
    ...
    {
        if($token){
            return $this->result[$token]?$this->result[$token]["os"]:null;
        }else{
    ...
    {
        if($token){
            return $this->result[$token]?$this->result[$token]["isiOs"]:false;
        }else{
    ...
    {
        if($token){
            return $this->result[$token]?$this->result[$token]["isAndroid"]:false;
        }else{
